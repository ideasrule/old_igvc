...
#define OPENCV2BOXFILTER_SHALLOW_COPY
...
public: 
...
#ifndef OPENCV2BOXFILTER_SHALLOW_COPY
	/**
	 ...
	 */ 
	void setBoxFilter(cv::Mat &destinationImage, cv::Rect boxPosition=cv::Rect(0,0,1,1), double scaleResultFactor=1.0) const; 
